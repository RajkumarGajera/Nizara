...
//        relativeLayout = root.findViewById(R.id.relativeLayout);
        ...
        Send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myRef.child("Review").child(product.getId().toString()).child(id).setValue(reviews).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
...
//
//                                }else{
//                                    productArrayList.remove(ApiConfig.GetProductList(jsonArray).get(i));
//                                }
////                                product1 = gson.fromJson(jsonObject.toString(), Product.class);
////                                System.out.println("Rajjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj"+ product1.getSubcategory_id());
////                                id = product1.getId();
