package onealldigital.nizara.in.helper;
...
public class Constant {
    ...
    public static final String BRAND_URL = BaseUrl + "get-brands.php";
    public static final String SUB_BRAND_URL = BaseUrl + "get-subbrands.php";
